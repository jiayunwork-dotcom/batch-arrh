...
// renderTable formats the trajectory as aligned columns: time, conversion
// and one column per species. Row selection mirrors the CLI expectation:
// with Rows = 0 and a long trajectory only the head and the tail are shown,
// separated by an ellipsis line.
