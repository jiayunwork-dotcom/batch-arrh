...
// buildResult runs a real first-order scenario end to end and returns the
// result the report renderers consume.
...
// TestReportShowsConversionAndConcentrations asserts that the text report
// carries the key conversion and every species concentration.
...
// TestReportTrajectoryStartsAtInitialState asserts that the table rendering
// begins at t = 0 with X = 0.
...
// TestJSONReportCarriesConversion asserts that the JSON form is
// parseable and reports the same conversion as the text form.
...
// TestJSONReportSeriesIncludesSelectivity asserts that a series result
// carries the selectivity and peak fields in JSON form.
